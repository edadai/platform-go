...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x1drefresh_token_expires_at_unix\x18\x06 \x01(\x03R\x19refreshTokenExpiresAtUnix\"\x9a\x01\n" +
	"\vUserMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12%\n" +
	"\x0eemail_verified\x18\x03 \x01(\bR\remailVerified\x12\x16\n" +
	"\x06status\x18\x04 \x01(\tR\x06status\x12&\n" +
	"\x0fcreated_at_unix\x18\x05 \x01(\x03R\rcreatedAtUnix\"\xd2\x02\n" +
	...
	"\rGetMeResponse\x12(\n" +
	"\x04user\x18\x01 \x01(\v2\x14.auth.v1.UserMessageR\x04user\"r\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x121\n" +
	"\acontext\x18\x03 \x01(\v2\x17.auth.v1.RequestContextR\acontext2\x82\x13\n" +
	"\vAuthService\x12E\n" +
	...
	"\aGetUser\x12\x17.auth.v1.GetUserRequest\x1a\x16.auth.v1.GetMeResponse\x12`\n" +
...
var file_auth_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*ValidateAccessTokenRequest)(nil),          // 24: auth.v1.ValidateAccessTokenRequest
	(*ValidateAccessTokenResponse)(nil),         // 25: auth.v1.ValidateAccessTokenResponse
	(*ValidateSessionRequest)(nil),              // 26: auth.v1.ValidateSessionRequest
	(*ValidateSessionResponse)(nil),             // 27: auth.v1.ValidateSessionResponse
	(*CheckRoleRequest)(nil),                    // 28: auth.v1.CheckRoleRequest
	(*CheckRoleResponse)(nil),                   // 29: auth.v1.CheckRoleResponse
	...
	(*ListSessionsRequest)(nil),                 // 32: auth.v1.ListSessionsRequest
	(*ListSessionsResponse)(nil),                // 33: auth.v1.ListSessionsResponse
	(*RevokeSessionRequest)(nil),                // 34: auth.v1.RevokeSessionRequest
	(*AssignRoleRequest)(nil),                   // 35: auth.v1.AssignRoleRequest
	(*RevokeRoleRequest)(nil),                   // 36: auth.v1.RevokeRoleRequest
	(*GrantUserPermissionRequest)(nil),          // 37: auth.v1.GrantUserPermissionRequest
	(*DenyUserPermissionRequest)(nil),           // 38: auth.v1.DenyUserPermissionRequest
	(*RemoveUserPermissionOverrideRequest)(nil), // 39: auth.v1.RemoveUserPermissionOverrideRequest
	(*SuspendUserRequest)(nil),                  // 40: auth.v1.SuspendUserRequest
	(*DeleteUserRequest)(nil),                   // 41: auth.v1.DeleteUserRequest
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	0,  // 0: auth.v1.RegisterRequest.context:type_name -> auth.v1.RequestContext
	0,  // 1: auth.v1.RequestEmailVerificationRequest.context:type_name -> auth.v1.RequestContext
	0,  // 2: auth.v1.VerifyEmailRequest.context:type_name -> auth.v1.RequestContext
	0,  // 3: auth.v1.LoginPasswordRequest.context:type_name -> auth.v1.RequestContext
	0,  // 4: auth.v1.RefreshSessionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 5: auth.v1.LogoutRequest.context:type_name -> auth.v1.RequestContext
	0,  // 6: auth.v1.LogoutAllRequest.context:type_name -> auth.v1.RequestContext
	0,  // 7: auth.v1.RequestPasswordResetRequest.context:type_name -> auth.v1.RequestContext
	0,  // 8: auth.v1.ResetPasswordRequest.context:type_name -> auth.v1.RequestContext
	0,  // 9: auth.v1.RequestEmailChangeRequest.context:type_name -> auth.v1.RequestContext
	0,  // 10: auth.v1.ConfirmEmailChangeRequest.context:type_name -> auth.v1.RequestContext
	0,  // 11: auth.v1.StartOAuthRequest.context:type_name -> auth.v1.RequestContext
	0,  // 12: auth.v1.CompleteOAuthRequest.context:type_name -> auth.v1.RequestContext
	0,  // 13: auth.v1.LinkOAuthRequest.context:type_name -> auth.v1.RequestContext
	0,  // 14: auth.v1.UnlinkOAuthRequest.context:type_name -> auth.v1.RequestContext
	0,  // 15: auth.v1.GetMeRequest.context:type_name -> auth.v1.RequestContext
	0,  // 16: auth.v1.GetUserRequest.context:type_name -> auth.v1.RequestContext
	3,  // 17: auth.v1.GetMeResponse.user:type_name -> auth.v1.UserMessage
	0,  // 18: auth.v1.ValidateAccessTokenRequest.context:type_name -> auth.v1.RequestContext
	0,  // 19: auth.v1.ValidateSessionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 20: auth.v1.CheckRoleRequest.context:type_name -> auth.v1.RequestContext
	0,  // 21: auth.v1.CheckPermissionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 22: auth.v1.ListSessionsRequest.context:type_name -> auth.v1.RequestContext
	4,  // 23: auth.v1.ListSessionsResponse.sessions:type_name -> auth.v1.SessionMessage
	0,  // 24: auth.v1.RevokeSessionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 25: auth.v1.AssignRoleRequest.context:type_name -> auth.v1.RequestContext
	0,  // 26: auth.v1.RevokeRoleRequest.context:type_name -> auth.v1.RequestContext
	0,  // 27: auth.v1.GrantUserPermissionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 28: auth.v1.DenyUserPermissionRequest.context:type_name -> auth.v1.RequestContext
	0,  // 29: auth.v1.RemoveUserPermissionOverrideRequest.context:type_name -> auth.v1.RequestContext
	0,  // 30: auth.v1.SuspendUserRequest.context:type_name -> auth.v1.RequestContext
	0,  // 31: auth.v1.DeleteUserRequest.context:type_name -> auth.v1.RequestContext
	5,  // 32: auth.v1.AuthService.Register:input_type -> auth.v1.RegisterRequest
	6,  // 33: auth.v1.AuthService.RequestEmailVerification:input_type -> auth.v1.RequestEmailVerificationRequest
	7,  // 34: auth.v1.AuthService.VerifyEmail:input_type -> auth.v1.VerifyEmailRequest
	8,  // 35: auth.v1.AuthService.LoginPassword:input_type -> auth.v1.LoginPasswordRequest
	9,  // 36: auth.v1.AuthService.RefreshSession:input_type -> auth.v1.RefreshSessionRequest
	10, // 37: auth.v1.AuthService.Logout:input_type -> auth.v1.LogoutRequest
	11, // 38: auth.v1.AuthService.LogoutAll:input_type -> auth.v1.LogoutAllRequest
	12, // 39: auth.v1.AuthService.RequestPasswordReset:input_type -> auth.v1.RequestPasswordResetRequest
	13, // 40: auth.v1.AuthService.ResetPassword:input_type -> auth.v1.ResetPasswordRequest
	14, // 41: auth.v1.AuthService.RequestEmailChange:input_type -> auth.v1.RequestEmailChangeRequest
	15, // 42: auth.v1.AuthService.ConfirmEmailChange:input_type -> auth.v1.ConfirmEmailChangeRequest
	16, // 43: auth.v1.AuthService.StartOAuth:input_type -> auth.v1.StartOAuthRequest
	18, // 44: auth.v1.AuthService.CompleteOAuth:input_type -> auth.v1.CompleteOAuthRequest
	19, // 45: auth.v1.AuthService.LinkOAuth:input_type -> auth.v1.LinkOAuthRequest
	20, // 46: auth.v1.AuthService.UnlinkOAuth:input_type -> auth.v1.UnlinkOAuthRequest
	21, // 47: auth.v1.AuthService.GetMe:input_type -> auth.v1.GetMeRequest
	22, // 48: auth.v1.AuthService.GetUser:input_type -> auth.v1.GetUserRequest
	24, // 49: auth.v1.AuthService.ValidateAccessToken:input_type -> auth.v1.ValidateAccessTokenRequest
	26, // 50: auth.v1.AuthService.ValidateSession:input_type -> auth.v1.ValidateSessionRequest
	28, // 51: auth.v1.AuthService.CheckRole:input_type -> auth.v1.CheckRoleRequest
	30, // 52: auth.v1.AuthService.CheckPermission:input_type -> auth.v1.CheckPermissionRequest
	32, // 53: auth.v1.AuthService.ListSessions:input_type -> auth.v1.ListSessionsRequest
	34, // 54: auth.v1.AuthService.RevokeSession:input_type -> auth.v1.RevokeSessionRequest
	35, // 55: auth.v1.AuthService.AssignRole:input_type -> auth.v1.AssignRoleRequest
	36, // 56: auth.v1.AuthService.RevokeRole:input_type -> auth.v1.RevokeRoleRequest
	37, // 57: auth.v1.AuthService.GrantUserPermission:input_type -> auth.v1.GrantUserPermissionRequest
	38, // 58: auth.v1.AuthService.DenyUserPermission:input_type -> auth.v1.DenyUserPermissionRequest
	39, // 59: auth.v1.AuthService.RemoveUserPermissionOverride:input_type -> auth.v1.RemoveUserPermissionOverrideRequest
	40, // 60: auth.v1.AuthService.SuspendUser:input_type -> auth.v1.SuspendUserRequest
	41, // 61: auth.v1.AuthService.DeleteUser:input_type -> auth.v1.DeleteUserRequest
	1,  // 62: auth.v1.AuthService.Register:output_type -> auth.v1.GenericMessageResponse
	1,  // 63: auth.v1.AuthService.RequestEmailVerification:output_type -> auth.v1.GenericMessageResponse
	1,  // 64: auth.v1.AuthService.VerifyEmail:output_type -> auth.v1.GenericMessageResponse
	2,  // 65: auth.v1.AuthService.LoginPassword:output_type -> auth.v1.SessionTokensResponse
	2,  // 66: auth.v1.AuthService.RefreshSession:output_type -> auth.v1.SessionTokensResponse
	1,  // 67: auth.v1.AuthService.Logout:output_type -> auth.v1.GenericMessageResponse
	1,  // 68: auth.v1.AuthService.LogoutAll:output_type -> auth.v1.GenericMessageResponse
	1,  // 69: auth.v1.AuthService.RequestPasswordReset:output_type -> auth.v1.GenericMessageResponse
	1,  // 70: auth.v1.AuthService.ResetPassword:output_type -> auth.v1.GenericMessageResponse
	1,  // 71: auth.v1.AuthService.RequestEmailChange:output_type -> auth.v1.GenericMessageResponse
	1,  // 72: auth.v1.AuthService.ConfirmEmailChange:output_type -> auth.v1.GenericMessageResponse
	17, // 73: auth.v1.AuthService.StartOAuth:output_type -> auth.v1.StartOAuthResponse
	2,  // 74: auth.v1.AuthService.CompleteOAuth:output_type -> auth.v1.SessionTokensResponse
	1,  // 75: auth.v1.AuthService.LinkOAuth:output_type -> auth.v1.GenericMessageResponse
	1,  // 76: auth.v1.AuthService.UnlinkOAuth:output_type -> auth.v1.GenericMessageResponse
	23, // 77: auth.v1.AuthService.GetMe:output_type -> auth.v1.GetMeResponse
	23, // 78: auth.v1.AuthService.GetUser:output_type -> auth.v1.GetMeResponse
	25, // 79: auth.v1.AuthService.ValidateAccessToken:output_type -> auth.v1.ValidateAccessTokenResponse
	27, // 80: auth.v1.AuthService.ValidateSession:output_type -> auth.v1.ValidateSessionResponse
	29, // 81: auth.v1.AuthService.CheckRole:output_type -> auth.v1.CheckRoleResponse
	31, // 82: auth.v1.AuthService.CheckPermission:output_type -> auth.v1.CheckPermissionResponse
	33, // 83: auth.v1.AuthService.ListSessions:output_type -> auth.v1.ListSessionsResponse
	1,  // 84: auth.v1.AuthService.RevokeSession:output_type -> auth.v1.GenericMessageResponse
	1,  // 85: auth.v1.AuthService.AssignRole:output_type -> auth.v1.GenericMessageResponse
	1,  // 86: auth.v1.AuthService.RevokeRole:output_type -> auth.v1.GenericMessageResponse
	1,  // 87: auth.v1.AuthService.GrantUserPermission:output_type -> auth.v1.GenericMessageResponse
	1,  // 88: auth.v1.AuthService.DenyUserPermission:output_type -> auth.v1.GenericMessageResponse
	1,  // 89: auth.v1.AuthService.RemoveUserPermissionOverride:output_type -> auth.v1.GenericMessageResponse
	1,  // 90: auth.v1.AuthService.SuspendUser:output_type -> auth.v1.GenericMessageResponse
	1,  // 91: auth.v1.AuthService.DeleteUser:output_type -> auth.v1.GenericMessageResponse
